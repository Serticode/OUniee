...
class RejectStaffApplicationDialogue extends StatefulWidget {
  final String theStaffEmail;
  const RejectStaffApplicationDialogue({Key? key, required this.theStaffEmail})
      : super(key: key);

  @override
  State<RejectStaffApplicationDialogue> createState() =>
      _RejectStaffApplicationDialogueState();
}

class _RejectStaffApplicationDialogueState
    extends State<RejectStaffApplicationDialogue> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          //!TITLE
          CustomTextWidget(
              pageTitle: "Reject Staff Application?",
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      SubmittedApplicationsController.applicationDenied(
